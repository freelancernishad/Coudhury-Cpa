...
Thank you for joining the **{{ config('app.name') }}** community. You've successfully subscribed to our blog newsletter. 
...
<x-mail::button :url="config('app.frontend_url', 'http://localhost:3001') . '/blog'">
